...
config_train.dataset.batch_size = 8 # Number of Samples before updating parameters and evaluate
config_train.dataset.K = 6 # Number of Images per Sample! used for training; need to be less than 6
